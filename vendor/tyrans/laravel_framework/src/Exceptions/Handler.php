...
use Tyrans\Framework\Contracts\ExceptionResponseable;
use Tyrans\Framework\Http\Request;
use Exception;
...
class Handler extends ExceptionHandler {
     ...
     * @throws \Tyrans\Framework\Exceptions\Exception
     */
    public function render($request, Exception $exception) {
        ...
        if (Request::createFromBase($request)->jsonResponse()) {
            switch (true) {
                ...
                default:
                    throw new \Tyrans\Framework\Exceptions\Exception($exception);
            }
        }
